...
void olc6502::clock()
{
    if (cycles == 0)
    {
        ...
        // Additional Cycle flags for opcodes
        uint8_t ac1 = (this->*lookup[opcode].addrmode)();
        uint8_t ac2 = (this->*lookup[opcode].operate)();
...
// =========================
// Interupts of the Emulator
// =========================

void olc6502::reset() // Reset
{
    a = 0;
    x = 0;
    y = 0;
